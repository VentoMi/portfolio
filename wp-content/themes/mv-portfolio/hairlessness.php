<?php /* Template Name: hairlessness */ ?>
<?php get_header(); ?>
<title>
    Portfolio - Hairlessness
</title>
<main>
    <section class="align-center ">
        <h2 class="hidden">
            Hairlessness pr&eacute;sentation
        </h2>
        ...
        srcset="http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/img/hair_background_380.jpg 380w,
        http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/img/hair_background_680.jpg 680w,
        http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/img/hair_background_1024.jpg 1040w,
        http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/img/hair_background.jpg 1280w"
        ...
        <section class="gridtwo marginLess first-section between-section" id="acad">
            <div class="flex__start div_img_hairlessness">
                <?php 
                    ...
                    http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/img/objetctif_net.jpg 1500w" width="650" class="img_back img imac imachair" alt="<?php echo $image['alt']; ?>" />
                <?php endif; ?>
            </div>
        ...
        <section class="gridtwo marginLess section_hairlessness between-section" id="hair">
            <div class="flex__start div_img_hairlessness">
                <?php 
                    ...
                    width="650" class="img imac imachair img_back" alt="<?php echo $image['alt']; ?>" />
                <?php endif; ?>
            </div>
            <div class="flex div_hairlessness">
                <h3 class="title border-blue blue">
    ...
    <div class="margin-top margin-bottom">
        <section class="gridtwo marginLess section_hairlessness sectionback between-section">
            ...
            <div class="flex__start div_img_hairlessness div_go_back div_baseline">
                ...
                http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/img/imac_back.jpg 1500w" width="650" class="baseline img imac imachair" alt="<?php echo $image['alt']; ?>" />
                <?php endif; ?>
            ...
            <div class="flex div_hairlessness div_go_back div_cta1">
                ...
                http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/img/Imac_acad.jpg 1500w" width="650" class="img imac imacnet flex_end" alt="<?php echo $image['alt']; ?>" />
                <?php endif; ?>

                <?php 
                $link = get_field('link-add-to-action2');
                if( $link ): ?>
                <a class="button white right button_visit_other flex_end" href="<?php echo $link; ?>">Visiter Acadexchange</a>
                <?php endif; ?>
            </div>
        </section>
    </div>
    <script src="http://hepl01.cblue.be/~user18/portfolio/wp-content/themes/mv-portfolio/ressources/js/typewriteHair.js">
    </script>
</main>
<?php get_footer(); ?>